  ...
  return (
    <div className="relative flex shrink-0 items-center gap-1">
      ...
      <button
        ...
        className={`${size} flex cursor-pointer items-center justify-center rounded-full bg-accent text-white shadow-sm transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60 ${
